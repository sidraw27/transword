...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('css/translation.css') }}"/>
</head>
<body>
<div class="tl_topnav-outer">
    <div class="tl_topnav"><a href="#">TRANSLATION</a></div>
</div>
<div class="tl_search-outer">
    <div class="tl_search">
        <div class="tl_search-box">
            <div class="search-icons"><img src="/images/search.svg" alt=""/></div>
            <div class="search-input">
                <input type="text" autocomplete="" placeholder=""/>
            </div>
            <div class="search-clear"><img src="/images/clear.svg" alt=""/><span>清除</span></div>
        </div>
    ...
    <div class="tl_container">
        <div class="tl_main-content">
            <div class="tl_info-box">
                <h1 class="info_keyword">Microwave</h1>
                <div class="info_speak-btn"><img src="/images/horn.svg" alt=""/></div>
            </div>
